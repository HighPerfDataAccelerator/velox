...
/// Spillable extension for the limit=1 row_number shape used by Job 144.
/// General row_number execution remains in the community CudfTopNRowNumber.
class CudfSpillableTopNRowNumber : public CudfOperatorBase {
 public:
  CudfSpillableTopNRowNumber(
      int32_t operatorId,
